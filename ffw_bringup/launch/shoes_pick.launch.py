    ...
    arguments = [
        ...
        DeclareLaunchArgument(
            ...
            description='Safety bound: ~/execute refuses to move at all if any '
                        'captured pose x exceeds this. Wider than box_pick/bottle_box '
        ...
        DeclareLaunchArgument(
            ...
            description='Position-based y correction, same pattern as box_pick.py: '
        ...
        DeclareLaunchArgument(
            ...
            description='Fixed gripper roll (rad); only yaw follows the shoe yaw '
                        '(unlike box_pick.py, which grasps from the side and rolls '
        ...
        # --- Place sequence (2 slots, same pattern as bottle_box.py) ----------------
        DeclareLaunchArgument(
        ...
        DeclareLaunchArgument(
            ...
            default_value='[0.45977485179901123, 0.23981253385543824, 0.9466336965560913]',
        ...
        DeclareLaunchArgument(
            ...
            default_value='1.1',
            description='Higher than bottle_box.py\'s 0.7 -- shoes need a firmer '
                        'grip.',
        ),
        DeclareLaunchArgument(
