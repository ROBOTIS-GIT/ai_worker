...
class BottleBox(PickPlaceNodeBase):
    ...
    (shared with box_pick.py); only the bottle-specific parameters and the actual
    ...
    # 방향은 항상 grasp_orientation 고정값 -- 병 방향에 안 따라감(이게 box_pick과의
    # 핵심 차이).
