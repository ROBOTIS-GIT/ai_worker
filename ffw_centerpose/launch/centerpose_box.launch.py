...
def generate_launch_description():
    # Measured grasp/yaw calibration + place/home positions are read directly from
    # config/ffw_sg2_rev1_follower/centerpose_box_calibration.yaml by the node itself.
