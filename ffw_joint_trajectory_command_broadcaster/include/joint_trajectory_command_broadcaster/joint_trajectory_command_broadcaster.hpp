...
#include "joint_trajectory_command_broadcaster/joint_position_safety_filter.hpp"
...
protected:
  ...
  JointPositionSafetyFilter position_safety_filter_;
  ...
  std::unordered_map<std::string, bool> follower_joint_validity_;
